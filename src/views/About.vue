		...
		<div class="skills">
			...
			<div class="columns has-text-centered mt-4">
				<div class="column is-half">
					...
					<p><a class="button is-primary mt-4 mb-6" href="#code">view code</a></p>
				</div>
				...
				<div class="column">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					<p><a class="button is-primary mt-4 mb-6" href="#designs">view designs</a></p>
				</div>
			</div>
			...
			<div class="columns has-text-centered">
				<div class="column is-half">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
					<p><a class="button is-primary mt-4 mb-6" href="#art">view art</a></p>
				</div>

				<div class="column">
					<i class="fas fa-chalkboard-teacher fa-5x"></i>
					<p class="heading">Mentoring</p>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
		...
		<div class="timeline is-centered">
			...
			<div class="timeline-item">
				...
				<div class="timeline-content">
					...
					<p class="has-text-weight-semibold">Vitamix</p>
					<p>Web Developer III</p>
				</div>
			</div>
			<header class="timeline-header">
			...
			<div class="timeline-item">
				...
				<div class="timeline-content">
					...
					<p class="has-text-weight-semibold">Dealer Tire</p>
					<p>IT Employee of the Quarter</p>
				</div>
			</div>
			<div class="timeline-item">
				<div class="timeline-marker"></div>
				<div class="timeline-content">
					<p class="heading">April 2019</p>
					<p class="has-text-weight-semibold">Dealer Tire</p>
			...
			<div class="timeline-item">
				...
				<div class="timeline-content">
					<p class="heading">August 2017</p>
					<p class="has-text-weight-semibold">Tech Elevator</p>
			...
			<div class="timeline-item">
				...
				<div class="timeline-content">
					...
					<p class="has-text-weight-semibold">Tech Elevator</p>
					<p>Began 14-Week Coding Bootcamp</p>
				</div>
			</div>
			<header class="timeline-header">
